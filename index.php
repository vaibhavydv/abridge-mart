<!DOCTYPE html>
<!-- saved from url=(0106)http://kalanidhithemes.com/live-preview/landing-page/prosoft-software-landing-page-html/defoult/index.html -->
<html lang="en" class="js csstransforms csstransforms3d csstransitions"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="icon" href="http://kalanidhithemes.com/live-preview/landing-page/prosoft-software-landing-page-html/defoult/images/logo-icon.png">
    
    <!-- Title -->
    <title>Abridge Mart</title>
  ...
  <!-- header -->
    <div class="header" id="header">
       <div class="container">
          <div class="row header-top affix-top" data-spy="affix" data-offset-top="70">
          <div class="container">
				<div class="row">
          ...
          <div class="col-xs-12 col-sm-12 col-md-6 module">
          	<div class="content-area">
               ...
               <p class="wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Use the cloud-based inventory tracking Web Application to perform inventory audits, avoid stockouts and maintain inventory levels. Real-time data and analytics keep you in charge of your inventory at all times.
                ...
                <div class="nomber-text wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                  <div class="nomber-text-row">
                     <div class="nomber-text-row-inner">
                       <span>1. Manage Orders</span>
                  ...
                  <div class="nomber-text-row">
                     <div class="nomber-text-row-inner">
                       <span>3. Multiple shipping integrations</span>
               ...
               <a href="app/" class="acc wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Go</a>
			</div>
          </div>
          <div class="col-xs-12 col-sm-12 col-md-6 module">
          	<div class="img3">
  ...
  <!-- why us End--> 
	...
	<div class="screen-section dark-section dark-color-bg" id="screens">
    	<div class="container">
		<div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12">
             <div class="heading">
                  <span>Previews</span>
                  <h2>Screenshot in details</h2>
               </div>
          </div>
        </div>
        <div class="pro_det_tab_main">
  ...
  <!-- Screens--> 
     <div class="section7 dark-section" id="screens" style="display:none;">
       <div class="container">
      <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12">
             <div class="heading">
 ...
 <!-- Team--> 
   <div class="section10" id="team">
       <div class="container">
       <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="heading">
                  <span>Abridge Mart</span>
       ...
       <div class="row pdtop2">
          <div class="col-lg-4 col-md-4 col-sm-4 module">
             <div class="team-box wow fadeIn" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fadeIn;">
               ...
               <div class="team-con">
               <p>Vaibhav Yadav here for Maintaning Website and Develop Using PHP 

               </p>
               </div>
               
               <div class="team-info">
                  <a href="http://facebook.com/vaibhavydv"><i class="icofont icofont-social-facebook"></i></a>
                  <a href="http://twitter.com/imvaibhavyadav"><i class="icofont icofont-social-twitter"></i></a>
                  <a href="http://plus.google.com/+VaibhavYadav"><i class="icofont icofont-social-google-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 module">
             <div class="team-box wow fadeIn" data-wow-duration="2s" style="visibility: visible; animation-duration: 2s; animation-name: fadeIn;">
               ...
               <div class="team-con">
               <p>
               Shankar Prasad here for Maintaning Frontend.
               </p>
               </div>
           ...
           <div class="col-lg-4 col-md-4 col-sm-4 module">
             <div class="team-box wow fadeIn" data-wow-duration="3s" style="visibility: visible; animation-duration: 3s; animation-name: fadeIn;">
               ...
               <div class="team-con">
               <p>
               Aliyas Ansari here for Managing Designing. 
               </p>
               </div>
   ...
   <div class="section14">
       ...
       <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-4">
             <div class="fool-box wow fadeInDown" data-wow-duration="1s" style="visibility: hidden; animation-duration: 1s; animation-name: none;">
                <i class="icofont icofont-download-alt"></i>
                <div class="footer-box-content">
	                <h4>Start now </h4>
    	            <p>Login  and start instant 
software</p>
					<a href="app/" class="acc">Click Here</a>
                </div>
             </div>
          </div>
          
          <div class="col-lg-4 col-md-4 col-sm-4">
             <div class="fool-box wow fadeInDown" data-wow-duration="2s" style="visibility: hidden; animation-duration: 2s; animation-name: none;">
                <i class="icofont icofont-phone"></i>
                <div class="footer-box-content">
	                <h4>Call us</h4>
    	            <p>If you have any quesry about ProSoft, please Call us on</p>
					<a href="#" class="">+91 945 776 8999</a>
                </div>
             </div>
          </div>
		...
		<div class="last-footer">
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            	<div class="footer-copy">
		            <p>© Copyright 2018 Abridge Mart</p>
                </div>
			</div>
           	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="foot-social">
               <a href="http://kalanidhithemes.com/live-preview/landing-page/prosoft-software-landing-page-html/defoult/index.html#"><i class="icofont icofont-social-facebook"></i></a>
               <a href="http://kalanidhithemes.com/live-preview/landing-page/prosoft-software-landing-page-html/defoult/index.html#"><i class="icofont icofont-social-twitter"></i></a>
               <a href="http://kalanidhithemes.com/live-preview/landing-page/prosoft-software-landing-page-html/defoult/index.html#"><i class="icofont icofont-social-google-plus"></i></a>
               <a href="http://kalanidhithemes.com/live-preview/landing-page/prosoft-software-landing-page-html/defoult/index.html#"><i class="icofont icofont-social-pinterest"></i></a>
               <a href="http://kalanidhithemes.com/live-preview/landing-page/prosoft-software-landing-page-html/defoult/index.html#"><i class="icofont icofont-social-youtube-play"></i></a>
            </div>
            </div>
            	</div>
			</div>
